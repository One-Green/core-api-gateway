...
from project.settings import MQTT_LIGHT_SENSOR_TOPIC
from project.settings import MQTT_LIGHT_CONTROLLER_TOPIC
from light.tasks import node_controller

CONTROLLED_DEVICE = "light"
BONJOUR: str = f"""
...
{MQTT_HOST=} 
{MQTT_PORT=}
{MQTT_LIGHT_SENSOR_TOPIC=}
{MQTT_LIGHT_CONTROLLER_TOPIC=}/<light-tag>
---------------------------------------------
...
class Command(BaseCommand):
    ...
    def on_connect(self, client, userdata, flags, rc):
        ...
        client.subscribe(MQTT_LIGHT_SENSOR_TOPIC)
